...
ArmpiControl::ArmpiControl(ros::NodeHandle& nh):nh_(nh),armpi_driver_(nh) {
  command_subscriber_ = new ArmpiCommandSubscriber(
    nh,
    [this](const geometry_msgs::Twist& base_velocity){armpi_driver_.publishChassisCommand(base_velocity);},
...
int main(int argc, char **argv)
{
  ...
  ROS_INFO("Robot Driver Initilized. Waiting for commands ...");
