...
class ArmpiDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        try:
            ...
            print(f"ERROR: {e}")
            return torch.randn(3, 224, 224),torch.zeros(len(self.state_columns)), torch.zeros(len(self.action_columns))
...
if __name__ == '__main__':
    print("TEST")
    armpi_dataset = ArmpiDataset(["bringup_red","bringup_red1","bringup_red2","bringup_red3","bringup_red4"])
